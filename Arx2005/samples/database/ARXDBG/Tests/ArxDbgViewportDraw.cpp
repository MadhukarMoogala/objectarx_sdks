...
Adesk::Boolean
ArxDbgGiViewportDraw::isValidId(const Adesk::UInt32 acgiId) const
{
                                    ...
                                    Adesk::Boolean transparency) const
{
    ...
    if (ArxDbgGiWorldDraw::m_showDetailsMsg) {
        ...
        printParamMsg(_T("PIXEL2DC MAT"), "Not Yet...");
        printParamMsg(_T("ENTITY ID"), "Not Yet...");
        printParamMsg(_T("IMAGE ORG"), "Not Yet...");
