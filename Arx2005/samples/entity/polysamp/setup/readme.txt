...
7. Create the following registry keys:
...
HKLM\SOFTWARE\Autodesk\ObjectDBX\R16.2\Applications\AsdkPolyObj

Note:  This is done to support older enabler versions loading in the newer hosts.  Since these three DBX versions are binary compatible, this is fine to do.  Generally, you will want to distribute each specific version (if you have specific builds) of the binaries within the installer...i.e. cumulatively.
