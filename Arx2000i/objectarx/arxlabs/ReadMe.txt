Welcome to the ObjectARX 2000 Training Tutorial. To view the tutorial, you will 
...
arxlabs          <- Contains 'Readme.txt' and 'ObjectARX 2000 Tutorial.htm' files.
  ...
  |_Step08       <- Contains completed application for Step 2 through to Step 7.


The labs consist of Step 1 through to Step 7. The folder 'Step08' contains the
...
To begin working on the ObjectARX 2000 Training Tutorial, use your web
browser to open the 'ObjectARX 2000 Tutorial.htm' file. Be sure to read the
requirements for ObjectARX 2000 outlined in the opening page. We hope you
enjoy the tutorial.
