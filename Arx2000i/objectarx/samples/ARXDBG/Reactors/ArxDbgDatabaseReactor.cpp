...
void
ArxDbgDatabaseReactor::headerSysVarWillChange(const AcDbDatabase* db, const char* name)
{
...
void
ArxDbgDatabaseReactor::headerSysVarChanged(const AcDbDatabase* db, const char* name,
