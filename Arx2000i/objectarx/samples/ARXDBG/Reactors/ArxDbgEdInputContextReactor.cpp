...
void
ArxDbgEdInputContextReactor::beginGetKeyword(const char* promptString,
                    int initGetFlags,
                    const char* pKeywords)
{
...
void
ArxDbgEdInputContextReactor::printPrompt(const char* promptStr) const
{
	if (promptStr)
...
void
ArxDbgEdInputContextReactor::printKeywords(const char* keywords) const
{
	if (keywords)
...
void
ArxDbgEdInputContextReactor::printKeywordPicked(const char*& keywordPicked) const
{
	if (keywordPicked)
