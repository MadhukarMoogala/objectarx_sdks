...
The Smiley application demonstrates several things:
 ...
 3) How to implement a COM Automation interface for an ObjectARX application
    (SmileyUiCom project)

 4) How to support the Properties Window with categorised properties (SmileyDbCom project)
...
to point to the appropriate DLL and TLB locations. The current values are based on
the default installation paths for AutoCAD 2000 and ObjectARX 2000.
