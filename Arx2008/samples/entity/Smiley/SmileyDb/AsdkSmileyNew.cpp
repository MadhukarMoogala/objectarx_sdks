...
const TCHAR kClassName[] = _T("AsdkSmiley");

//const char kProgID[] = "SmileyDb.Entity";
...
Adesk::Boolean
AsdkSmiley::cloneMeForDragging()
{
    return AcDbEntity::cloneMeForDragging();  //  Adesk::kFalse;
}
...
AsdkSmiley::list() const
{
    ...
    acutPrintf(
        ...
        _T("%7s eye radius %9.16q0\n")
        _T("%7s eye height %9.16q0\n")
        _T("%7s eyes apart %9.16q0\n"),
        _T(""), cen[X], cen[Y], cen[Z], _T(""),
        rad, _T(""), meyesize, _T(""),
        meyesheight, _T(""), meyesapart
    );
}
