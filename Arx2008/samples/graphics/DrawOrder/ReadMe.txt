...
AutoCAD and ObjectARX are trademarks of Autodesk, Inc., in the 
...
1. Enter "ARX" on the Command Line of AutoCAD.
...
2. Type "sortbylayer" command. A dialog should show up. 
	...
	b. Click "Sort By Entity Order" button, layers in the listbox will be reordered based on the draw order of
	...
	d. Click "Sort By Layer Order" button. The list box will again list all the layers in the order that they are stored in the layer table.
...
3. Type "draworderbylayer" command. 
	...
	b. Draw an entity above the topmost entity on a layer different from the topmost entity The entity should be drawn behind the topmost entity.
	c. type "draworderbylayer" command again.
	d. Enter no after above prompt.
	e. Draw an entity above the topmost entity on a layer different from the topmost entity. The entity is drawn above the topmost entity.

4. Type "reverseInLayer" command.
	a. A prompt shows up with the names of all the layers in the dawing.
	b. Choose one layer name.
	c. All the entities on that layer will be redrawn in a reverse order.
