...
public:
	...
	BEGIN_PERPROPDISPLAY_MAP2()
			PROP_DISP_ENTRY2(1, _T("AcPEXCtl.AcPePropertyEditorColor.16"), NULL, NULL, NULL, NULL, 0x000000ff, FALSE, 1, 0)
			PROP_DISP_ENTRY2(2, _T("AcPEXCtl.AcPePropertyEditorLayer.16"), NULL, NULL, NULL, NULL, 0x000000ff, FALSE, 1, 0)
			PROP_DISP_ENTRY2(3,_T("AcPEXCtl.AcPePropertyEditorEllipses.16"),NULL,NULL,NULL,NULL,0x000000ff, FALSE, 1, 0)
