...
void initApp()
{
  ...
  acedRegCmds->addCommand( _T(/*NOXLATE*/"ASDK_PROGRESSBAR"),  // Group name 
                           _T(/*NOXLATE*/"ASDK_PROGBAR"),      // Global function name
                           _T("progbar"),                      // Local function name
                           ACRX_CMD_MODAL,                 // Type
...
void unloadApp()
{
  ...
  //
  acedRegCmds->removeGroup( _T(/*NOXLATE*/"ASDK_PROGRESSBAR") );
