...
//-----------------------------------------------------------------------------
//----- TextFileFieldUI.cpp : Initialization functions
#include "StdAfx.h"
//-----------------------------------------------------------------------------
...
AC_IMPLEMENT_EXTENSION_MODULE(TextFileFieldUIDLL)
...
#ifdef NEVER
AFX_EXTENSION_MODULE TextFileFieldUIExtDLL ={ NULL, NULL } ;
#endif
...
BOOL WINAPI DllMain (HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved) {
	...
	if ( dwReason == DLL_PROCESS_ATTACH ) {
		...
		TextFileFieldUIDLL.AttachInstance (hInstance) ;
		InitAcUiDLL () ;
	} else if ( dwReason == DLL_PROCESS_DETACH ) {
		TextFileFieldUIDLL.DetachInstance () ;
	}
	return (TRUE) ;
}
