...
#Region "Misc"
        ...
        Public Overrides Function Polypoint(ByVal points As Autodesk.AutoCAD.Geometry.Point3dCollection, ByVal normals As Autodesk.AutoCAD.Geometry.Vector3dCollection, ByVal subentityMarkers As Autodesk.AutoCAD.Geometry.IntegerCollection) As Boolean
            MyUtil.displayMsg(MethodInfo.GetCurrentMethod().Name)
            Return True
        End Function
#End Region
