...
To run the sample:
	...
	Copy the Tool1.bmp and the SimpleToolPaletteExample.dll file to the AutoCAD installation folder (for your final installation, you may prefer to add your assembly to the Global Assembly Cache instead).
