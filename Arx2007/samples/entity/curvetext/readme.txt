...
first time only, manually load the .dbx module and then the .arx module in
AutoCAD using the "APPLOAD" command.

Make sure you have a curve in the drawing (say a circle), and then type "CURVETEXT"
...
"CURVETEXT" at the command prompt, will load the required components automatically.
