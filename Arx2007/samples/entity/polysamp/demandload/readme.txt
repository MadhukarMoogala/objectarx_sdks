...
Execute these tasks in order first:
  ...
  1. Using a text editor, update polysamp.reg.
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R17.0\ACAD-5001:409\Applications\AsdkPolyCAD]
...
I. Command Invocation
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R17.0\ACAD-5001:409\Applications\AsdkPolyCAD\Commands]
     "ASDK_POLY"="POLY"
  ...
  3. Invoking the command POLY defined in polyui.arx will Demand
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R17.0\ACAD-5001:409\Applications\AsdkPolyCAD\Groups]
