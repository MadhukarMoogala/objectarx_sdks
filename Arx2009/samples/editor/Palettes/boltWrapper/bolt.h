...
public:
	...
	OPMPROP_ENTRY(0, DISPID_POSITION,	  PROPCAT_Position, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_ALIGNMENT,	  PROPCAT_Alignment, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_COLOR,        PROPCAT_Color,     0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_HEADDIAMETER, PROPCAT_Dimension, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_HEADHEIGHT,	  PROPCAT_Dimension, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_HEADSIDES,	  PROPCAT_Dimension, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_SHAFTDIAMETER,PROPCAT_Dimension, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_SHAFTLENGTH,  PROPCAT_Dimension, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_THREADLENGTH ,PROPCAT_Dimension, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_THREADWIDTH,  PROPCAT_Dimension, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_MATERIALNAME, PROPCAT_Part_Desc, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	OPMPROP_ENTRY(0, DISPID_PARTNUMBER,	  PROPCAT_Part_Desc, 0, 0, 0, _T(""), 0, 1, IID_NULL, IID_NULL, "")
	END_OPMPROP_MAP()
	...
	PROP_DISP_ENTRY(DISPID_POSITION, _T(""), MAKEINTRESOURCE(IDB_BITMAP1), PICTYPE_BITMAP, NULL,
					PICTYPE_UNINITIALIZED, RGB(255, 0, 0), false, 1, PROPCAT_Position_Weight)
	PROP_DISP_ENTRY(DISPID_ALIGNMENT, _T(""), MAKEINTRESOURCE(IDB_BITMAP2), PICTYPE_BITMAP, NULL,
