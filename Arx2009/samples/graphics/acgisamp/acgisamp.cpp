...
void initApp()
{
    ...
    acedRegCmds->addCommand( _T("ACGISAMP_COMMANDS"), _T("FACETFACES"), _T("FACETFACES"),
        ACRX_CMD_MODAL, &shadeface );
    acedRegCmds->addCommand( _T("ACGISAMP_COMMANDS"), _T("SETCOLORINDEX"), _T("SETCOLORINDEX"),
        ACRX_CMD_MODAL, &setColorIndex );
    acedRegCmds->addCommand( _T("ACGISAMP_COMMANDS"), _T("SETDEVIATION"), _T("SETDEVIATION"),
...
void unloadApp()
{
    acedRegCmds->removeGroup( _T("ACGISAMP_COMMANDS") );
}
