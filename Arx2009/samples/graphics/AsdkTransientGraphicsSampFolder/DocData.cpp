...
CDocData::CDocData ()
{
	m_pInputPointMonitor = NULL;
	m_pTransientEntity = NULL;
}
...
CDocData::~CDocData () 
{
	if(m_pInputPointMonitor != NULL)
		delete m_pInputPointMonitor;

	m_pInputPointMonitor = NULL;


	if(m_pTransientEntity != NULL)
		delete m_pTransientEntity;

	m_pTransientEntity = NULL;
}


void CDocData::ClenUp()
{
	if(m_pInputPointMonitor != NULL)
		delete m_pInputPointMonitor;
