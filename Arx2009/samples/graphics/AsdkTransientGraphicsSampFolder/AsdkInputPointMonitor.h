...
//-----------------------------------------------------------------------------
//----- AsdkInputPointMonitor.h : Declaration of the AsdkInputPointMonitor
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ AsdkInputPointMonitor : public AcEdInputPointMonitor {

public:
	ACRX_DECLARE_MEMBERS(AsdkInputPointMonitor) ;
...
public:
	AsdkInputPointMonitor (AcApDocument *pDoc =NULL) ;
	virtual ~AsdkInputPointMonitor () ;
...
#ifdef ASDKTRANSIENTGRAPHICS_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(AsdkInputPointMonitor)
#endif
