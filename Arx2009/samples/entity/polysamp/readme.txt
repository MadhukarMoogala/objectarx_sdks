...
acui17.lib, nor any library which directly or indirectly causes a 
...
Compiling Your Help File in Visual Studio 2005
==============================================
The Microsoft Help Compiler (hcw.exe) no longer ships with Visual Studio. To continue compiling your context sensitive help files (.hpj) in Visual Studio 2005, download the Microsoft Help Workshop from Microsoft and install it to Common7\Tools in your Visual Studio 2005 folder. 

To compile an HPJ file from within the development environment

1. Open your project in Visual Studio. 
2. In the Solution explorer browse to the help project file. Right click and select Properties. 
3. In the property pages window for the HPJ file, select Configuration Properties->General in the left pane. 
4. Select Custom Build Tool in the Tool option in the right pane. 
5. Select Custom Build Step in the left pane. 
6. In the right pane type the following in the Command Line field:

	hcw /e /c /m $(InputFileName)

7. Type $(InputName).hlp in the outputs field. 
