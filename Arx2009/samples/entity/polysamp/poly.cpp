...
Acad::ErrorStatus 
AsdkPoly::highlight (const AcDbFullSubentPath& path , const Adesk::Boolean highlightAll) const
{
    ...
    return AcDbEntity::highlight(path,highlightAll);
}

Acad::ErrorStatus 
AsdkPoly::unhighlight(const AcDbFullSubentPath& path, const Adesk::Boolean highlightAll) const
{
    AcDbObjectId id = objectId();
#ifdef _DEBUG
    ...
    acdbQueueForRegen(&id,1);
    mShowAffordances = false;
    return AcDbEntity::unhighlight(path,highlightAll);
}
