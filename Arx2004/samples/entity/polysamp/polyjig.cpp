...
Adesk::Boolean 
AsdkPolyJig::dragAcquire(char* promptString,
                         char* name,
                         AcDbObjectId tsId)
{
    ...
    case kNoChange:
        delete mPoly;
        acutPrintf("The drag status is kNoChange\n");
        break ;
    case kCancel:
        delete mPoly;
        acutPrintf("The drag status is kCancel\n");
        break ;
    case kOther:
        delete mPoly;
        acutPrintf("The drag status is kOther\n");
        acutPrintf("Invalid Instance\n");
        break ;
    case kNull:
        delete mPoly;
        acutPrintf("The drag status is kNull\n");
        break ;
    default:
        delete mPoly;
        acutPrintf("The drag status is %d\n", stat);
        break ;
    }
