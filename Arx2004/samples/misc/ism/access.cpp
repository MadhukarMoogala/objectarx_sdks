// (C) Copyright 1996,1998, 2001, 2002 by Autodesk, Inc. 
//
...
AcRx::AppRetCode acrxEntryPoint(AcRx::AppMsgCode msg, void* pkt) 
{
    switch(msg) {
	    case AcRx::kInitAppMsg:
            ...
            // Load in the db portion of the ISM
            if (!acrxDynamicLinker->loadModule("acISMobj16.dbx", true)) {
	    ...
	    case AcRx::kUnloadAppMsg:
	        unloadModule();
            // Unload the db portion of the ISM
            acrxDynamicLinker->unloadModule("acISMobj16.dbx");
			break;
