...
void
ArxDbgEventReactor::dwgFileOpened(AcDbDatabase* db, char* fileName)
{
    CString str;
...
void
ArxDbgEventReactor::beginSave(AcDbDatabase* db, const char* pIntendedName)
{
    CString str;
...
void
ArxDbgEventReactor::saveComplete(AcDbDatabase* db, const char* pActualName)
{
    CString str;
...
void
ArxDbgEventReactor::beginInsert(AcDbDatabase* pTo, const char* pBlockName, AcDbDatabase* pFrom)
{
    CString str;
