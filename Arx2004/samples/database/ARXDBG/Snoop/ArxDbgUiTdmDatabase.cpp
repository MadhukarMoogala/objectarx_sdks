...
ArxDbgUiTdmDatabase::ArxDbgUiTdmDatabase(AcDbDatabase* db, CWnd* parent, const char* winTitle)
...
ArxDbgUiTdmDatabase::ArxDbgUiTdmDatabase(const AcDbObjectId& dictId, CWnd* parent, const char* winTitle)
:   CAcUiTabMainDialog(ArxDbgUiTdmDatabase::IDD, parent, ArxDbgApp::getApp()->dllInstance()),
