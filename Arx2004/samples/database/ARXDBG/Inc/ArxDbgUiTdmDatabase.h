...
public:
            ArxDbgUiTdmDatabase(AcDbDatabase* db, CWnd* parent, const char* winTitle = NULL);
			ArxDbgUiTdmDatabase(const AcDbObjectId& dictId, CWnd* parent, const char* winTitle = NULL);	// when you just want page for extension dict
