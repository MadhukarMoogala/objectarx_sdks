...
//
//
#include "lab6ObjectEmployeeEntry.h"
#include "dbproxy.h"
...
ACRX_DXF_DEFINE_MEMBERS(EmployeeEntry,AcDbObject,AcDbProxyEntity::kNoOperation,
						AcDb::kDHL_CURRENT, AcDb::kMReleaseCurrent, OARXLABS_EMPLOYEEENTRY, lab6);
