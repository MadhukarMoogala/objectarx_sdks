...
#include "lab5objectemployeedetails.h"
...
acrxEntryPoint(AcRx::AppMsgCode msg, void* pkt) 
{
    ...
    case AcRx::kInitAppMsg:
        ...
        if (acrxServiceDictionary->at(EMPLOYEE_DETAILS_SERVICE)){
			acutPrintf("Cannot continue bacaue an other module has registered the service\nnamed EMPLOYEE_DETAILS_SERVICE or EMPLOYEE_ENTRY_SERVICE\nUNLOADING!" );
