...
**	to other entities.  See ArxDbgDbAdeskLogo.cpp and ArxDbgDbGraphicsContainer.cpp
...
public:
    ...
    virtual Acad::ErrorStatus   deepClone(AcDbObject* pOwner,
                                        AcDbObject*& pClonedObject,
                                        AcDbIdMapping& idMap,
                                        Adesk::Boolean isPrimary) const;

    virtual Acad::ErrorStatus   wblockClone(AcRxObject* pOwner,
                                        AcDbObject*& pClone,
                                        AcDbIdMapping& idMap,
                                        Adesk::Boolean isPrimary) const;
