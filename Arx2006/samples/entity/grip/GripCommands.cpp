...
//////////////////////////////////////////////////////////////////////////
// globals
int gRectHorizDynDimSetting = AcDbDimData::DimDataFlags::kDimEditable|
															AcDbDimData::DimDataFlags::kDimHideIfValueIsZero|
															AcDbDimData::DimDataFlags::kDimFocal;
int gRectVertDynDimSetting =	AcDbDimData::DimDataFlags::kDimEditable|
															AcDbDimData::DimDataFlags::kDimHideIfValueIsZero|
															AcDbDimData::DimDataFlags::kDimFocal;
int gCircleDynDimSetting=		AcDbDimData::DimDataFlags::kDimEditable|
															AcDbDimData::DimDataFlags::kDimHideIfValueIsZero|
															AcDbDimData::DimDataFlags::kDimFocal|
															AcDbDimData::DimDataFlags::kDimRadius;
...
int SetDynDimModesFor(const TCHAR *command, const TCHAR *dim, int &flag)
{
	...
	AcArray<std::string> DynDimOptionsStrings;
	DynDimOptionsStrings.append("");
