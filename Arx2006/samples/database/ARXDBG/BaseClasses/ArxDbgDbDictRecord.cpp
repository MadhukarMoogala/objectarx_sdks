...
void
ArxDbgDbDictRecord::setDescription(const char* val)
{
...
ArxDbgDbDictRecord::dwgOutFields(AcDbDwgFiler* filer) const
{
    ...
    filer->writeItem(static_cast<const char*>(m_description));
...
ArxDbgDbDictRecord::dxfOutFields(AcDbDxfFiler* filer) const
{
    ...
    filer->writeItem(kDxfDescription, static_cast<const char*>(m_description));
...
Acad::ErrorStatus
ArxDbgDbDictRecord::wblockClone(AcRxObject* pOwner,
							...
							Adesk::Boolean isPrimary) const
{
    ...
    if ((dc != AcDb::kDcXrefBind) &&
        ...
        return AcDbObject::wblockClone(pOwner, pClonedObject, idMap, isPrimary);
    }
