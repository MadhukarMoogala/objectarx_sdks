...
#import "AcETransmit16.tlb" raw_interfaces_only, raw_native_types, no_namespace, named_guids 
...
class ATL_NO_VTABLE CAddFileHandler : 
	...
	public IDispatchImpl<IAddFileHandler, &IID_IAddFileHandler, &LIBID_asdkETRANSMITLib>,
