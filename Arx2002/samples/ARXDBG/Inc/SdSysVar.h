...
private:
    ...
    resbuf*        m_prevValue;
        ...
        // outlawed functions
                        SdSysVarNode(const& SdSysVarNode);
    SdSysVarNode&        operator=(const& SdSysVarNode);
};
...
public:
    ...
    void        push(LPCTSTR varName, const char*);
...
private:
    ...
    void        addNewNode(LPCTSTR varName, const resbuf* newVal);
        ...
        // outlawed functions
                    SdSysVarStack(const& SdSysVarStack);
    SdSysVarStack&    operator=(const& SdSysVarStack);
};
