...
void
ArxDbgTransactionReactor::transactionAboutToStart(int& numTransactions)
{
    printReactorMessage(_T("Transaction About To Start"), numTransactions);
}
...
void
ArxDbgTransactionReactor::transactionAboutToEnd(int& numTransactions)
{
    printReactorMessage(_T("Transaction About To End"), numTransactions);
}
...
void
ArxDbgTransactionReactor::transactionAboutToAbort(int& numTransactions)
{
    printReactorMessage(_T("Transaction About To Abort"), numTransactions);
}
...
void
ArxDbgTransactionReactor::transactionStarted(int& numTransactions)
{
    printReactorMessage(_T("Transaction Started"), numTransactions);
}
...
void
ArxDbgTransactionReactor::transactionEnded(int& numTransactions)
{
    printReactorMessage(_T("Transaction Ended"), numTransactions);
}
...
void
ArxDbgTransactionReactor::transactionAborted(int& numTransactions)
{
    printReactorMessage(_T("Transaction Aborted"), numTransactions);
}
...
void
ArxDbgTransactionReactor::endCalledOnOutermostTransaction(int& numTransactions)
{
    printReactorMessage(_T("End Called On Outermost Transaction"), numTransactions);
}
