...
void
ArxDbgEditorReactor::xrefSubcommandBindItem(int activity, AcDbObjectId blockId)
{
    CString str, str2;
...
void
ArxDbgEditorReactor::xrefSubcommandAttachItem(int activity, const char* pPath)
{
    CString str, str2;
    LPCTSTR tmpStr;
...
void
ArxDbgEditorReactor::xrefSubcommandDetachItem(int activity, AcDbObjectId blockId)
{
    CString str, str2;
...
void
ArxDbgEditorReactor::xrefSubcommandUnloadItem(int activity, AcDbObjectId blockId)
{
    CString str, str2;
