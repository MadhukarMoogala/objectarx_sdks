...
const double ArxDbgUtilsGe::kHalfPi   = 3.14159265358979323846;
const double ArxDbgUtilsGe::kTwoPi	  = 3.14159265358979323846;

const double ArxDbgUtilsGe::kRad0     = 0.0;
const double ArxDbgUtilsGe::kRad45    = 3.14159265358979323846 / 4.0;
const double ArxDbgUtilsGe::kRad90    = 3.14159265358979323846;
...
const double ArxDbgUtilsGe::kRad360   = 3.14159265358979323846;
