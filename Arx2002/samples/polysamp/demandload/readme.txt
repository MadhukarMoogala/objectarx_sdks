...
I. Command Invocation
  ...
  3. Invoking the command POLY defined in polyui.arx will Demand
     ...
     Due to this possible situation, the registry key "Groups" is introduced as a 
     way to determine the application to demand load according to the command.
     ...
     Currently, ambiguous commands setup for demand loading result 
     in "unkown command", when a group name is not used. A handler will be 
...
under your company name. For example, replace 
"\Autodesk\ObjectARX\3.0\SampleApps\PolySamp" with your company name.

The InstallShield sample on the ObjectARX CD provides another methods of setting 
up Demand Loading.
